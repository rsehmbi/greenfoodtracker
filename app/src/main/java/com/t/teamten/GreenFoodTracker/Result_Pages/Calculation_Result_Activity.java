...
public class Calculation_Result_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Calculator_Data userInput = getIntent().getParcelableExtra(Calculator_Activity.DATA_PASSED_FROM_MAINACTIVITY);


        mPLedgeAmount = findViewById(R.id.pledge_the_amount);
        ...
        try {
            foodData = new Food_Data(this.getApplicationContext());
        } catch (IOException e) {
            e.printStackTrace();
        }

        final Integer totalEmission = (int) new Calculation_Result_Data_Handler(this).total_emission(userInput, foodData);
    ...
    private void initialize_seek_bar_data(Calculator_Data userInput)
    {
    ...
    {
        final Integer total_after_adjustment = (int) new Calculation_Result_Data_Handler(this).total_emission(seek_bar_name,seek_bar_data, foodData);
