...
public class Pledge_Recycler_View_Adapter extends RecyclerView.Adapter<Pledge_Recycler_View_Adapter.PledgeViewHolder> {
    private List<Pledge_Post> posts;
    private Context context;
    private ProfileIconList iconList;

    public Pledge_Recycler_View_Adapter(Context context, List<Pledge_Post> posts) {
