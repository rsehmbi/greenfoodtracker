    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        city.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(User_Profile_Activity.this,"City field is Empty", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        gender.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(User_Profile_Activity.this,"Gender field is Empty", Toast.LENGTH_SHORT).show();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    case R.id.Calculator:
                        Toast.makeText(User_Profile_Activity.this,"Calculator",Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(User_Profile_Activity.this,Calculator_Activity.class);
                        startActivity(intent);
                        break;
                    case R.id.Facts:
                        Toast.makeText(User_Profile_Activity.this,"Facts",Toast.LENGTH_SHORT).show();
                        Intent intent3 = new Intent(User_Profile_Activity.this,Facts_Activity.class);
                        startActivity(intent3);
                        break;
                    case R.id.About:
                        Toast.makeText(User_Profile_Activity.this,"Settings",Toast.LENGTH_SHORT).show();
                        Intent intent2 = new Intent(User_Profile_Activity.this, Setting_For_User_Activity.class);
                        startActivity(intent2);
                        break;
                    case R.id.Pledge:
                        Toast.makeText(User_Profile_Activity.this,"Pledge",Toast.LENGTH_SHORT).show();
                        Intent movetoPledge = new Intent(User_Profile_Activity.this, User_Profile_Activity.class);
                        startActivity(movetoPledge);
                        break;
                    case R.id.Newsfeed:
                        Toast.makeText(User_Profile_Activity.this,"HomeScreen",Toast.LENGTH_SHORT).show();
                        Intent movetoHomeScreen = new Intent (User_Profile_Activity.this,HomeScreen.class);
    ...
    public boolean onTouchEvent(MotionEvent touchEvent){
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1 < x2){
                    Intent i = new Intent(User_Profile_Activity.this,Calculator_Activity.class);
                    startActivity(i);
                }else if(x1 > x2){
                    Intent i = new Intent(User_Profile_Activity.this,HomeScreen.class);
                    startActivity(i);
                }
                break;
        }
